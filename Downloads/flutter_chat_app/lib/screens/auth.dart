  ...
  void _submit() async {
    ...
    if(!isValid || !_isLogin && _selectedImage == null){
      ...
      if(_isLogin){
        ...
        await FirebaseFirestore.instance //firestore firebase data storing
            .collection('users')
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (value){
                              if(value == null || value.trim().length<4 ){
                                return 'User Name must be at least 4 char long.';
                              }
                              return null;
                            },
                            onSaved: (value){
                          ...
                          TextFormField(
                           ...
                           obscureText: true,
                            validator: (value){
                              if(value == null || value.trim().length<4 ){
                                return 'Password must be at least 4 char long.';
                              }
                              return null;
                            },
                            onSaved: (value){
